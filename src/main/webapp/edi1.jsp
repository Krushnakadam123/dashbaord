...
<div class="container-fluid">
        ...
        <form  action="edit" method="post" >
            ...
            <div id="info" class="tab active">
                <div class="box">
                    ...
                    <input type="hidden" name="sid" value="<%= (student != null ? student.getSid() : "") %>" />
  					...
  					<div class="wrapper">
               		 <div class="input-field">                    <label for="name">Name:</label>
                ...
                <input list="coll" type="text" id="gender" name="gender"  value="<%= (student !=null ? student.getGender() :"") %>" required />
                <datalist id="coll">
                    <option value="Female">
                    <option value="Male">
                 </datalist> 
                 ...
                 <label for="course_name">CourseName:</label>
                    <input type="text" id="course_name" name="course_name" value="<%= (student != null ? student.getCourseName() : "") %>" readonly required />
                 </div>
            ...
            <div id="education" class="tab">
                <div class="box">
                    ...
                    <input type="date" id="date_registered" name="date_registered" value="<%= (student != null ? student.getDate_registered() : "") %>" required />
 ...
 /* Assuming the form has the necessary data
   

     // Send the request
      async function updateEdit(sid) {
